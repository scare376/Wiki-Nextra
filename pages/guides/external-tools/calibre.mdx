...
6. Now it should be at the bottom of Current Actions. You can click on it then click the up and down arrows to the right to move it to the location you want it.
